"""
extraction_plan_v2.py — Pure ontology-driven extraction plan (no config file).
...
Reads the OWL/TTL ontology and produces a JSON plan of:
  ...
  - role_hints: generic clinical guideline patterns for table classification

No guideline_config.json dependency. All patterns are generic clinical
guideline vocabulary, not disease-specific.
"""
...
def build_extraction_plan(ontology_path: str) -> dict:
    """Build extraction plan from the ontology alone."""
    g = Graph()
    ...
    role_hints = {
        ...
        "pregnancy_management": {
            "description": "Disease management across pregnancy continuum",
        ...
        "advanced_definition": {
            "description": "Definitions and criteria for advanced disease",
        ...
        "clinical_indicator": {
            "description": "Clinical indicators of advanced disease",
    ...
    return {
        ...
        "notes": [
            ...
            "Disease identity and metadata are extracted from the document at runtime.",
        ],
    }
