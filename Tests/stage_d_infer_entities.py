"""
Test Stage d: statements_with_medical_entities → infer:entities → candidate_statements

Entity linking (UMLS or rule-based) and candidate statement detection.
"""
...
# Stage d config (align with pipeline; set umls_csv_path=None for rule-based only)
STAGE_D_CONFIG = {
    "umls_csv_path": None,  # "data/UMLS.csv" for UMLS linking
    "filter_unmatched": False,
    "use_partial_umls_match": False,  # True = slower, more matches on large UMLS
}
...
def test_stage_d():
    """Test Stage d: Entity linking and candidate inference."""
    print("=" * 70)
    ...
    # Reconstruct StatementsWithMedicalEntities from saved data
    ...
    # Step 2: Initialize entity linker
