"""
Test Stage e: candidate_statements → validate → validated_facts_AND_qualifiers

This stage extracts factual statements (subject, predicate, object, exception, duration) using LLM.
No factuality validation—experts validate manually. Multiple statements per chunk supported.
Requires transformers library and GPU - best tested in Colab.
"""
...
def test_stage_e():
    """Test Stage e: LLM extraction (no factuality validation)."""
    print("=" * 70)
    ...
    # Reconstruct CandidateStatements from saved data
    ...
    # Step 4: Extract factual statements from candidate chunks
